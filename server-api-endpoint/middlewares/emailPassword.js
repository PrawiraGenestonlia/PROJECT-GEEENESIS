...
async function emailPassword(user, password) {
  ...
  const mailOptions = {
    ...
    <p>
      ...
      As part of mentoring system, you are required to download the application at https://www.x-dream.tech/genesis-main. We have also created an account on your behalf.</p>
